...
<div id="content">
  ...
  <div class="middle">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          ...
          <td style="padding-left: 15px; width: 296px; vertical-align: top;"><table width="100%">
              ...
              <?php  if ($display_mycatalog) {  //MK mycatalog add ?>
                  <form action="<?php echo str_replace('&', '&amp;', $mycatalog_add_action); ?>" method="post" enctype="multipart/form-data" id="mycatalog_add">

                 <td><a title="<?php echo $add_print_text; ?>" onclick="$('#mycatalog_add').submit();" id="add_to_mycatalog"  ><img src="<?php echo $mycatalog_add; ?>" /></a> </td>
 
                 <div>
                 <input type="hidden" name="redirect" value="<?php echo str_replace('&', '&amp;', $redirect); ?>" />                
                 </div>
                 </form>
                 <?php  if ($display_mycatalog_print) {  ?>
                  <form action="<?php echo str_replace('&', '&amp;', $mycatalog_print_action); ?>" method="post" enctype="multipart/form-data" id="mycatalog_print">

                 <td><a title="<?php echo $print_text; ?>" onclick="$('#mycatalog_print').submit();" id="print_mycatalog"  ><img src="<?php echo $mycatalog_print; ?>" /></a></td>
                 ...
                 <input type="hidden" name="redirect" value="<?php echo str_replace('&', '&amp;', $redirect); ?>" />                
                  ...
                  <form action="<?php echo str_replace('&', '&amp;', $mycatalog_clear_action); ?>" method="post" enctype="multipart/form-data" id="mycatalog_clear">

                 <td><a title="<?php echo $clear_text; ?>" onclick="$('#mycatalog_clear').submit();" id="clear_mycatalog"  ><img src="<?php echo $mycatalog_clear; ?>" /></a></td>
    ...
    <div class="tabs">
      ...
      <?php if (isset($originator_name)) { //MK share ?>
      <a id="tab_reply_id" tab="#tab_reply" style="background:#FFFFCC;" ><?php echo "Reply to: ".$originator_name; ?> </a> 
      <?php } ?>  
     ...
     <a tab="#tab_share" ><?php echo $tab_share; //MK share ?> </a>
