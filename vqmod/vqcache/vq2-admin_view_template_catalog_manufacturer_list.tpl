...
<?php } ?>
      ...
      <?php if (in_array(0, $manufacturer_store)) { ?>
       [<a onClick="window.open('<?php echo $store . 'index.php?route=product/manufacturer/product&manufacturer_id=' . $manufacturer['manufacturer_id']; ?>');">View in <?php echo basename($store); ?></a>]<br />
       <?php } ?>
      <?php foreach ($stores as $storel) { ?>
        <?php if (in_array($storel['id'], $manufacturer_store)) { ?>
        [<a onClick="window.open('<?php echo $storel['href'] . 'index.php?route=product/manufacturer/product&manufacturer_id=' . $manufacturer['manufacturer_id']; ?>');">View in <?php echo $storel['name']; ?></a>]<br />
      <?php } ?>
