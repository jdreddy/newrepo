...
$this->data['text_brand_filter'] = $this->language->get('text_brand_filter');
			...
			// get manufacturers for child categories
...
$this->data['manufacturer_filter'] = $manufacturer_filter;
			$this->data['sort'] = $sort;
