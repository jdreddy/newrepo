...
$_['bf_signature']						= "Brainy Filter 2.2. Created <a href=\"http://giantleaplab.com/\">Giant Leap Lab</a> &copy; 2014";
...
$_['entry_auto_submission']  	 	= '<b>Any filter setting change.</b> Apply the filter once a user changes any of the filter settings.';
$_['entry_auto_submission_delay']  	= '<b>Several filter settings change.</b> Apply the filter once a user stops changing settings. Stopping means no actions within a certain predefined time period.';
...
$_['entry_stock_status_id']			= 'Out of stock text constant';
